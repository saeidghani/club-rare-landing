    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Answer Governance  have made
      ...
      return (
        <div>
          {/* <p>Attention AGOV Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with AGOV is AGOV/yCRV
            (Curve yPool tokens)
          </p>
