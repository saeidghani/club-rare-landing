  ...
  return (
    <>
      ...
      <StyledFarm>
        ...
        <Spacer size="md"/>
        <StyledHeading>{t('yourstaking')}</StyledHeading>
        {account &&
          <StyledCardsWrapper>
            <StyledCardWrapper>
              <Harvest pid={pid} />
        ...
        <StyledCardsWrapper>
          <div>
            ...
            <StyledInfoLP>
              ...
              <div><a style={{color: '#f6b944', textDecoration: 'none'}} href={pairLink} target="__blank"><b>{symbolShort} pair</b></a> 
              {t('addliquidityto')} </div>    
                <Spacer size="sm" />
